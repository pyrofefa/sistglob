...
export function buildInsertPayloads(data: CapturaSimto): {
  params: any;
  values: any[];
} {
  const {
  ...
  const values = [
    ...
    captura.trampa_id,
    siembra_id,
    captura.totalTrampas,
    captura.totalInsectos,
    captura.fenologia,
  ];
...
export function buildUpdatePayloads(data: CapturaSimto): {
  params: any;
  values: any[];
} {
  const {
