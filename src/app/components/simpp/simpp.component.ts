...
@Component({
  selector: 'app-simpp',
  templateUrl: './simpp.component.html',
  styleUrls: ['./simpp.component.scss'],
  standalone: false,
})
export class SimppComponent implements OnInit {
  @Input() name: any;
  @Input() id: any;
  @Input() campana: any;
 ...
 private async startGPSWatch() {
  ...
  compareWithAccionesFn(a: any, b: any): boolean {
    return a === b;
  }
  getAcciones() {
    this.accion
  ...
  compareWithObservacionFn(a: any, b: any): boolean {
    return a === b;
  }
  getObservaciones() {
    this.observacion
      ...
      .then((res) => {
        ...
        this.compareWithObservacion = this.compareWithObservacionFn;
      })
      .catch((error) => {
        alert(error);
      });
